...
the _username_ on the remote system, and `r config$remote$login` represents
the cluster's login address (_hostname_). Together, they form the SSH command:
`r paste0("ssh ", config$remote$user, "@", config$remote$login)`.
