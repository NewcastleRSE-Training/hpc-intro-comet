...
```bash
[user@cometlogin01(comet) ~] sacct -u yourUsername
```
...
```bash
[user@cometlogin01(comet) ~] sacct -u yourUsername --long --jobs 347087
```
...
```bash
[user@cometlogin01(comet) ~] sacct -u yourUsername --long --jobs 347087 | less -S
```
